# MicroPython Websocket helper
# source https://github.com/micropython/webrepl/blob/master/websocket_helper.py
# The MIT License (MIT) - Copyright (c) 2018 Lauri Võsandi
